...
A DaVinci Resolve Studio Workflow Integration with focus on automation and tools for video creation.
...
## Installation
**Note** This integration only works with the studio version of DaVinci Resolve.
